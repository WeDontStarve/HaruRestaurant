			...
			success : function(data) {
				...
				for (var i = 0, l = json.length; i < l; i++) {
					table += '<tr>';
						...
						table += '<td>' + json[i].order_id + '</td>';
						table += '<td>' + json[i].table_id + '</td>';
						table += '<td>' + json[i].total_price + '</td>';
...
<div class="nav notify-row" id="top_menu">
   <input type="text" class="form-control" style="width:80%;padding-left:10%;padding-top:0%;">
</div>
      ...
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <thead>
          <tr>
            ...
            <th style="text-align:center;">上菜状况</th>
          </tr>
        </thead>
        <tbody id="orderTable">
