...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-2" data-genuitec-path="/web/WebRoot/DishesManagement.jsp">
<section id="container" class="wrap" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-2" data-genuitec-path="/web/WebRoot/DishesManagement.jsp">
<!--header start-->
 ...
 <div class="panel panel-default">
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <thead>
          <tr>
            <th data-breakpoints="xs">菜品ID</th>
            <th>名称</th>
            <th>单价</th>
            <th>照片</th>
