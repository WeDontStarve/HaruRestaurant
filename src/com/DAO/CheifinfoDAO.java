...
public class CheifinfoDAO extends BaseHibernateDAO {
	...
	public List findByExample(Cheifinfo instance) {
		...
		try {
			List results = getSession().createCriteria("com.DAO.Cheifinfo")
	...
	public List findByCheifSalary(Object cheifSalary) {
		return findByProperty(CHEIF_SALARY, cheifSalary);
	}

	public List findByCheifBonus(Object cheifBonus) {
